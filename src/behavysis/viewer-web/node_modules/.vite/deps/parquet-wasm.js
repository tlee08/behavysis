...
function readParquetStream(url, content_length) {
  ...
  const len0 = WASM_VECTOR_LEN;
  const ret = wasm.readParquetStream(ptr0, len0, isLikeNone(content_length) ? 4294967297 : content_length >>> 0);
  return ret;
}
...
export {
  ...
  WriterVersion,
  _functionTable,
  parquet_wasm_default as default,
  initSync,
  readParquet,
  readParquetStream,
  readSchema,
...
//# sourceMappingURL=parquet-wasm.js.map
