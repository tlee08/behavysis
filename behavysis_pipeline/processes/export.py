...
class Export:
    ...
    def feather_2_feather(src_fp: str, dst_fp: str, overwrite: bool) -> str:
        """__summary__"""
        # Reading file
    ...
    @staticmethod
    @IOMixin.overwrite_check()
    def feather_2_csv(src_fp: str, dst_fp: str, overwrite: bool) -> str:
        """__summary__"""
        # Reading file
        df = DFIOMixin.read_feather(src_fp)
        # Writing file
    ...
    def predbehav_2_scoredbehav(
        src_fp: str, dst_fp: str, configs_fp: str, overwrite: bool
    ) -> str:
        """__summary__"""
