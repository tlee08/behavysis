# Running BA_Package with Docker
...
**Step 5:**
To run the `BA_Package` program, enter the following command into the terminal:
```zsh
docker run --name ba_package_container -it --rm -p 8888:8888 -v "${PWD}":/app ba_package:core
```
